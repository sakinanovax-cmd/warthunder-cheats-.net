...
export const productInfo = {
	...
	features: {
		esp: [
			'Tank, aircraft, and ship ESP / wallhack',
			'Crew and threat cues',
			'Capture zone markers',
			'Distance readouts',
			'Toggleable ESP categories',
			'Air, Ground, and Naval filters',
		],
		aimbot: [
			'Soft aim and gunner assist',
			'Smoothness and FOV settings',
			'Lead and bone priority',
			'Hotkeys mid-match',
			'Per-vehicle profiles',
		],
		radar: ['2D radar overlay', 'Adjustable range', 'Works in Air, Ground, and Naval battles'],
		general: [
