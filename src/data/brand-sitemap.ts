...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'war thunder cheats esp',
		caption: 'war thunder cheats esp wallhack',
	},
	{
		src: '/images/war-thunder-cheats-wallhack.webp',
		title: 'war thunder cheats wallhack',
		caption: 'war thunder cheats wallhack esp',
	},
	{
		src: '/images/war-thunder-cheats-aimbot.webp',
		title: 'war thunder cheats aimbot',
		caption: 'war thunder cheats aimbot soft aim',
	},
	{
		src: '/images/war-thunder-cheats-aimbot-view.webp',
		title: 'war thunder cheats aimbot',
		caption: 'war thunder cheats aimbot view',
	},
	{
		src: '/images/war-thunder-cheats-radar.webp',
		title: 'war thunder cheats radar',
		caption: 'war thunder cheats radar hack',
	},
	{
		src: '/images/war-thunder-cheats-raid.webp',
		title: 'war thunder cheats',
		caption: 'war thunder cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in War Thunder', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'war-thunder-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'war-thunder-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for War Thunder on PC' },
