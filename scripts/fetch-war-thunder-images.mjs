...
import { buildOverlaySvg } from './war-thunder-hack-overlays.mjs';

const imagesDir = path.resolve('public/images');
const publicDir = path.resolve('public');

/** Verified IGN War Thunder screenshot CDN paths. */
...
/**
 * War Thunder cheats image pipeline:
 * 1. Download real War Thunder gameplay from IGN
 * 2. Composite ESP / aimbot / radar / mod-menu overlays for war thunder cheats marketing
 */
const KEYWORD_ASSETS = [
	{
		file: 'war-thunder-cheats-hero.webp',
		url: `${ME_G}/war-thunder-screenshots_wjkx.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'war-thunder-cheats-aimbot.webp',
		url: `${ME}/war-thunder-screenshots_wjb1.1400.jpg`,
		overlay: 'aimbot',
	},
	{
		file: 'war-thunder-cheats-esp-wallhack.webp',
		url: `${ME}/war-thunder-screenshots_55fp.1400.jpg`,
		overlay: 'wallhack',
	},
	{
		file: 'war-thunder-squad-fight.webp',
		url: `${ME}/war-thunder-screenshots_67cp.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'war-thunder-cheats-package.webp',
		url: `${ME}/war-thunder-screenshots_anf4.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'war-thunder-cheats-cover.webp',
		url: `${ME}/war-thunder-screenshots_7pr8.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'war-thunder-header-art.webp',
		url: `${ME}/war-thunder-screenshots_c36j.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'war-thunder-loadout-builder.webp',
		url: `${NL}/war-thunder-screenshots_e5gw.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'war-thunder-battle-royale-combat.webp',
		url: `${ME}/war-thunder-screenshots_4h92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'war-thunder-capture point-fight.webp',
		url: `${BR}/goulag-inside_zusa.1400.png`,
		overlay: 'capture point',
	},
	{
		file: 'war-thunder-player-esp.webp',
		url: `${ME}/war-thunder-screenshots_rb92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'war-thunder-scav-run-combat.webp',
		url: `${BR}/plunder_px6d.1400.png`,
		overlay: 'scav-run',
	},
	{
		file: 'war-thunder-scav-run-mode.webp',
		url: `${BR}/parachuting_qhh2.1400.png`,
		overlay: 'loot',
	},
	{
		file: 'war-thunder-verdansk-map.webp',
...
const REMOVE_PATTERNS = [
	/^fortnite-/,
	/-\d+w\.webp$/i,
	/^war-thunder-cheats-logo/,
];

async function fetchBase(url) {
	const res = await fetch(url, {
		headers: { 'User-Agent': 'Mozilla/5.0 (compatible; War ThunderHacksSite/1.0)' },
	});
...
async function cleanImagesDir() {
	...
	for (const file of files) {
		if (file.includes('war-thunder-cheats-logo')) continue;
...
console.log(`\nDone — ${saved}/${KEYWORD_ASSETS.length} War Thunder cheats images (IGN base + ESP/aimbot overlays).`);
