#!/usr/bin/env node
/**
 * Ports the 8 posts from ../war-thunder-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'war-thunder-blog', 'src', 'content', 'posts');
...
const file = `/* Auto-generated by scripts/port-from-war-thunder-blog.mjs — do not edit by hand. */
