...
const KW = {
	...
	hack: 'war thunder cheat',
	esp: 'war thunder esp',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'war thunder aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar War Thunder Cheats', undetected: 'indetectables', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'Contacta support@warthundercheats.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter War Thunder Cheats', undetected: 'indétectables', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'Contactez support@warthundercheats.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'War Thunder Cheats kaufen', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar War Thunder Cheats', undetected: 'indetectáveis', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'Contacte support@warthundercheats.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista War Thunder Cheats', undetected: 'indetectable', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'Contatta support@warthundercheats.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'War Thunder Cheats kopen', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'War Thunder Cheats satın al', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'Destek ve yasal sorular için support@warthundercheats.net.',
	},
	ar: {
		buy: 'اشترِ War Thunder Cheats', undetected: 'غير مكتشف', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'War Thunder Cheatsを購入', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'サポート・法務: support@warthundercheats.net',
	},
	ko: {
		buy: 'War Thunder Cheats 구매', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => '지원 및 법무: support@warthundercheats.net',
	},
	zh: {
		buy: '购买 War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => '支持与法务：support@warthundercheats.net',
	},
	hi: {
		buy: 'War Thunder Cheats खरीदें', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'सहायता: support@warthundercheats.net',
	},
	id: {
		buy: 'Beli War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp War Thunder Cheats', undetected: 'undetected', maps: 'Sinai, Kursk, and Berlin',
		...
		legal: () => 'support@warthundercheats.net för support och juridik.',
	},
};
